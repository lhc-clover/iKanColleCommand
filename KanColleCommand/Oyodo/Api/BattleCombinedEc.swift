...
class BattleCombinedEc: JsonBean {

    var api_result: Int = 0
    var api_result_msg: String = ""
    var api_data: BattleCombinedEcData? = BattleCombinedEcData()
...
//            Battle.instance.calcFriendOrdinalDamage(damageList: it.api_stage3?.api_fdam)
        ...
        Battle.instance.phaseShift(value: Phase.BattleCombinedEc)
    }
}

class BattleCombinedEcData: HandyJSON {
